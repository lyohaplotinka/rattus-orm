...
function createPlugin(options) {
  ...
  const filterFile = createFilter(
    (_c = (_b = options == null ? void 0 : options.filter) == null ? void 0 : _b.files) == null ? void 0 : _c.include,
    (_e = (_d = options == null ? void 0 : options.filter) == null ? void 0 : _d.files) == null ? void 0 : _e.exclude,
  )
  return {
...
function prepareCompilerOptions(cache, file, options) {
  ...
  const location =
    ((_b = options == null ? void 0 : options.tsconfig) == null ? void 0 : _b.location) ??
