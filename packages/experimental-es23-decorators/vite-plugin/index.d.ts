import { Plugin, FilterPattern, PluginOption } from 'vite';
...
declare function createPlugin(options?: Options): PluginOption;

export { Options, createPlugin as vitePluginTypescriptTransform };
