...
<h1 align="center">Rattus ORM – experimental-es23-decorators</h1>

**experimental-es23-decorators data provider and helpers for Rattus ORM**
...
```bash
yarn add @rattus-orm/core @rattus-orm/experimental-es23-decorators
```
### Basic usage
...
